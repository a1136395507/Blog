...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "../static/images/ChinaChess/"+stype+"/bg.png";

	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "../static/images/ChinaChess/"+stype+"/dot.png";

	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "../static/images/ChinaChess/"+stype+"/"+ com.args[i].img +".png";
	}

	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "../static/images/ChinaChess/"+stype+"/r_box.png";

	document.getElementsByTagName("body")[0].style.background= "url(../static/images/ChinaChess/"+stype+"/bg.jpg)";
